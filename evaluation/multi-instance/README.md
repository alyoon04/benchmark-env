...
|---|---|---|---|---|
| `ansible/ansible` (combine_vars) | Python | ✅ solvable | ✅ solvable | [`../ansible-combine-vars/`](../ansible-combine-vars/): stub gold → RESOLVED, no-op → UNRESOLVED, **Claude → RESOLVED** (claude-opus-4-7, $2.37; Claude's fix differs from the gold patch). |
